...
1. `docs/design/domains/{ドメイン名}/index.md` — ドメインの概要とユースケース
2. `docs/design/domains/{ドメイン名}/ドメインモデル.md` — 集約・エンティティ・値オブジェクトの構造、対訳表
3. `docs/design/domains/{ドメイン名}/業務ルール.md` — ライフサイクル、バリデーション、ビジネスルール
