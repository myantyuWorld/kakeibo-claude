...
`docs/design/domains/{ドメイン名}/index.md` を読み、リンクされている関連ドキュメントを全て確認する。
...
1. `docs/design/domains/{ドメイン名}/業務ルール.md` から指定ユースケースのビジネスルールを確認する
2. `docs/design/domains/{ドメイン名}/ドメインモデル.md` の対訳表で命名を確認する
3. 以下のファイルを実装・更新する
